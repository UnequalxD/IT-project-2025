...
type
    ...
    procedure addComponent(pnl:TPanel);
    procedure removeComponent(index: Integer);
	end;
...
procedure TGraph.addComponent(pnl:TPanel);
begin
  Self.components.Add(pnl);
end;
...
begin
	inherited;
	FInstances.Add(Self);
  Self.components := Tlist<TPanel>.Create;
end;
...
procedure TGraph.removeComponent;
begin
